...
class KDTree
{
  public:
    ...
    void buildTree(vector<Point<Dim>>& points, int left, int right, int dimension);

    void quickSelect(vector<Point<Dim>>& points, int n, int left, int right, int dimension);

    int partition(vector<Point<Dim>>& points, int pivotIndex, int left, int right, int dimension);
    ...
    Point<Dim> findNearestNeighbor(const Point<Dim>& query, Point<Dim>& currentBest, int left, int right, int dimension) const;
