...
void testReverse()
{
    ...
    checkSoln(__func__, out, "soln_reverse.png");
     ...
     List<int> list2;  // insertBack
    for (size_t i = 1; i <= 15; i++)
        list2.insertBack(i);
    list2.reverse();
    cout << "reverse: " << list2 << endl;
    list2.reverse();
    cout <<"reverse twice: " <<list2 <<endl;

	List<int> list3; //empty?
	list3.reverse();
	cout<<"reverse empty: " << list3 <<endl;
...
void testReverseNth()
{
    ...
    for (size_t i = 1; i <= 20; i++)
        list2.insertBack(i);
    list2.reverseNth(2);
    cout << "reverse2: " << list2 << endl;

	list2.reverse();
	cout<< "reverse reverse2: " << list2 <<endl;
